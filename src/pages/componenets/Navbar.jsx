...
const Navbar = () => {
    ...
    return (
        <div className=''>
            <nav className=" shadow-sm text-white border-b-2 border-[#A6907A] absolute top-0 left-0 w-full z-50 bg-[#A6907A] bg-opacity-100">
                <div className="w-full">
                    <div className="flex items-center h-20 w-full">
                        <div className="flex items-center md:justify-evenly md:px-0 px-6 w-full">
                            {/* <a href="/">
                                <img priority={true} className='md:w-40 w-32' src='/logoNavbar.png' alt="Guzel Wpc Logo" />
                            </a> */}
                            <div className="hidden md:block">
                                <ul className='hidden md:flex space-x-4'>
                                    <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                        <a href={"/#about-us"} className=" text-[#EFE8DD] font-font-main font-semibold hover:text-[#714A2D]">
                                            {("About Us")}
                                        </a>
                                    </li>
                                    {/* <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                        <a href={"/#wpc-industry"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-[#714A2D]">
                                            {("WPC Industry")}
                                        </a>
                                    </li> */}
                                    <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                        <a href={"/#our-products"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-[#714A2D]">
                                            {("Product List")}
                                        </a>
                                    </li>
                                    <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                        <a href={"/#contact-us"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-[#714A2D]">
                                            {("Contact Us")}
                                        </a>
                                    </li>
                                </ul>
                    ...
                    {(ref) => (
                        <div className="md:hidden bg-black py-5" id="mobile-menu">
                            <ul className='flex flex-col items-start w-full text-base cursor-pointer space-y-6 py-10'>
                                <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                    <a href={"/#about-us"} className=" text-[#EFE8DD] font-font-main font-semibold hover:text-white">
                                        {("About Us")}
                                    </a>
                                </li>
                                <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                    <a href={"/#wpc-industry"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-white">
                                        {("WPC Industry")}
                                    </a>
                                </li>
                                <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                    <a href={"/#our-products"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-white">
                                        {("Product List")}
                                    </a>
                                </li>
                                <li className="ml-4 my-0 hover:scale-105 transition duration-300">
                                    <a href={"/#contact-us"} className="text-[#EFE8DD] font-font-main font-semibold hover:text-white">
                                        {("Contact Us")}
                                    </a>
                                </li>
                            </ul>
